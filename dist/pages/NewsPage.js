...
const sections = [
    {
        ...
        markup: () => (React.createElement(React.Fragment, null,
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Gene Signature Scores"),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted mt-3" }, "Annotation Columns"),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted mt-3" }, "Data download"),
    ...
    },
    {
        ...
        markup: () => (React.createElement(React.Fragment, null,
            ...
            React.createElement("h4", null, "New data"),
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Database"),
            React.createElement("p", null, "All data has be been updated from hg19 to hg38!"),
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "HLA-A type, Mutational Burden and MSI Status"),
            React.createElement("p", null,
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Basic statistical analyses"),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Improved column operations (filtering, sorting, etc)"),
            React.createElement("p", null,
                React.createElement("i", null, "How to access"),
            ...
            React.createElement("p", null,
                ...
                "."),
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Interactive help tours"),
            ...
            React.createElement("p", null,
                ...
                "."),
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Briefly noted"),
    ...
    },
    {
        ...
        markup: () => (React.createElement(React.Fragment, null,
            React.createElement("p", { className: "lead text-muted" },
                ...
                React.createElement("b", null, "bug fixes"),
                ". The most important changes are:"),
            React.createElement("h5", { className: "text-muted" }, "Session management"),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Session sharing"),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Download data"),
    ...
    },
    {
        ...
        markup: () => (React.createElement(React.Fragment, null,
            React.createElement("p", { className: "lead text-muted" },
                ...
                React.createElement("b", null, "bug fixes"),
                ". The most important changes are:"),
            React.createElement("h5", { className: "text-muted" }, "Improved column headers and column menus"),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, "Improved column sorting and grouping."),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, " Improved aggregated columns"),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, " Improved column types"),
            ...
            React.createElement("br", null),
            React.createElement("h5", { className: "text-muted" }, " Improved user interface"),
            ...
            React.createElement("h5", { className: "text-muted" }, "   Improved performance"),
