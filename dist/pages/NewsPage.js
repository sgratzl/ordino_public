                ...
                React.createElement("div", { className: "container pb-10 pt-5" },
                    React.createElement("div", { className: "row" },
                        React.createElement("div", { className: "col" }, sections.map((item, index) => {
                            ...
                            React.createElement(OrdinoScrollspyItem, { className: "pt-3 pb-5", id: `card${index}_${suffix}`, key: item.name, index: index, handleOnChange: handleOnChange, children: React.createElement(React.Fragment, null,
