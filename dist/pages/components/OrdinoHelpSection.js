...
export function OrdinoHelpSection() {
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "scrollspy-nav flex-column ms-4 nav" },
                        ...
                        React.createElement("div", { className: "col position-relative" },
                            React.createElement(Element, { name: `element-${1}` },
                                React.createElement("h4", { className: "text-start  mt-2 mb-3" },
                                    React.createElement("i", { className: "me-2 ordino-icon-2 fas fa-mountain" }),
                                    " Ordino at a Glance"),
                    ...
                    React.createElement("div", { className: "row mt-6" },
                        React.createElement("div", { className: "col position-relative" },
                            React.createElement(Element, { name: `element-${2}` },
                                React.createElement("h4", { className: "text-start mt-2 mb-3" },
                                    React.createElement("i", { className: "me-2 ordino-icon-2 fas fa-at" }),
                                    " Contact us"),
                    ...
                    React.createElement("div", { className: "row mt-6" },
                        React.createElement("div", { className: "col position-relative" },
                            React.createElement(Element, { name: `element-${3}` },
                                React.createElement("h4", { className: "text-start mt-2 mb-3" },
                                    React.createElement("i", { className: "me-2 ordino-icon-2 fas fa-exclamation-triangle " }),
                                    " Disclaimer"),
                    ...
                    React.createElement("div", { className: "row mt-6" },
                        React.createElement("div", { className: "col position-relative" },
                            React.createElement(Element, { name: `element-${4}` },
                                React.createElement("h4", { className: "text-start mt-2 mb-3" },
                                    React.createElement("i", { className: "me-2 ordino-icon-2 fas fa-smile" }),
                                    " Terms of Use"),
                    ...
                    React.createElement("div", { className: "row mt-6" },
                        React.createElement("div", { className: "col position-relative" },
                            React.createElement(Element, { name: `element-${5}` },
                                React.createElement("h4", { className: "text-start mt-2 mb-3" },
                                    React.createElement("i", { className: "me-2 ordino-icon-2 fab fa-github" }),
                                    " Source Code ",
                                    '&',
                                    " Licenses"),
                                React.createElement("div", { className: "card shadow-sm" },
