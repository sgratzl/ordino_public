            ...
            React.createElement(Row, null,
                React.createElement(Col, { sm: 2 },
                    React.createElement(Nav, { style: { position: 'fixed' }, className: "scrollspy-nav flex-column" },
                        React.createElement(Link, { className: "nav-link pl-5", role: "button", activeClass: "nav-active", to: `element-${1}`, spy: true, smooth: true, offset: -180, duration: 500 }, "Ordino at a glance"),
                        React.createElement(Link, { className: "nav-link pl-5", role: "button", activeClass: "nav-active", to: `element-${2}`, spy: true, smooth: true, offset: -180, duration: 500 }, "Contact us"),
                        React.createElement(Link, { className: "nav-link pl-5", role: "button", activeClass: "nav-active", to: `element-${3}`, spy: true, smooth: true, offset: -180, duration: 500 }, "Disclaimer"),
                        React.createElement(Link, { className: "nav-link pl-5", role: "button", activeClass: "nav-active", to: `element-${4}`, spy: true, smooth: true, offset: -200, duration: 500 }, "Terms of Use"),
                        React.createElement(Link, { className: "nav-link pl-5", role: "button", activeClass: "nav-active", to: `element-${5}`, spy: true, smooth: true, offset: -230, duration: 500 }, "Source code"))),
