...
export function PublicationPage() {
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "position-relative pt-5" },
            React.createElement(OrdinoScrollspy, { items: publications.map((section) => ({ id: section.id, name: section.name })) }, (handleOnChange) => React.createElement(React.Fragment, null,
