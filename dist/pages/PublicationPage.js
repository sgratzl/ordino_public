    ...
    return React.createElement("div", { className: "row" },
        React.createElement("div", { className: "shadow-sm card p-2 overflow-hidden" },
            React.createElement("div", { className: "card-body" },
                ...
                React.createElement("p", { className: "card-text" }, "Tourdino was presented at the EuroVis Workshop on Visual Analytics. Please consider a citation when using Ordino and publishing your results."),
