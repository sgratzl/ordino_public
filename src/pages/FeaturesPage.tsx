      ...
      <Container className="my-9">
        ...
        <Row md={2}>
          ...
          <FeatureCard title="Database Info View" >
            Database Info view for showing metadata stored in the database for all selected items. The
          ...
          <FeatureCard title="OncoPrint View" >
            OncoPrint view showing a horizontal series of colored blocks (glyphs) for each gene selected.
            ...
            status (green=mutated, gray=non mutated, white=unknown) of a cell line or tissue sample.
          </FeatureCard>
